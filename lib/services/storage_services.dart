...
class StorageServices {
  ...
  final DatabaseReference _database = FirebaseDatabase.instanceFor(
    ...
    databaseURL: 'https://attendance-app-3ec15-default-rtdb.asia-southeast1.firebasedatabase.app/'
  ).ref(); //databaseURL diambil dr realtime database di web firebase
  ...
  Future<String> uploadAttendancePhoto(String localPath, String photoType) async {
    try {
      ...
      // compresses image to reduce size (important for realtime database)
